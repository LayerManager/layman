...
| [qgis-server](https://docs.qgis.org/3.16/en/docs/server_manual/index.html) | 3.16 | GNU GPL v2 | layermanager/qgis-server | prod-external | bin | to provide WMS endpoint |
...
| [Dockerfile/qgis-server](https://github.com/LayerManager/docker-qgis-server) | GNU GPL v3 | docker-compose.yml | dev | bin | |
