...
| [firefox-geckodriver](https://launchpad.net/ubuntu/bionic/+package/firefox-geckodriver) | 95+ | MPL | Dockerfile | prod | bin | for client-side map rendering and integration testing |
