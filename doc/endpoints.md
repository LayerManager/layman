...
- Bounding box of each layer referenced in incoming Insert, Replace, Update, or Delete WFS-T request is updated in asynchronous task after the request is finished. 
