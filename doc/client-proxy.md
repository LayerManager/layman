...
Values of X-Forwarded headers does not affect responses of [GET Layer Metadata Comparison](rest.md#get-layer-metadata-comparison) and [GET Map Metadata Comparison](rest.md#get-map-metadata-comparison) intentionally, in order to keep URLs in canonical form.
