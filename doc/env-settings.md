...
### LAYMAN_GS_PROXY_PORT
Port part of GeoServer [Proxy Base URL](https://docs.geoserver.org/2.21.x/en/user/configuration/globalsettings.html). Whole Proxy Base URL is automatically set on Layman's startup.
