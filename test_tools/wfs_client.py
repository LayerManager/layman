...
from layman.layer.geoserver import GeoserverIdsForSource, GeoserverIds
...
def post_wfst(workspace, publ_type, name,
    ...
    wfs_layer = GeoserverIds(uuid=uuid).wfs if uuid else GeoserverIdsForSource(workspace=workspace, name=name)
