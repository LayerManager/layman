...
def task_postrun(workspace, publication_type, publication_name, task_id, task_name, task_state):
    ...
    if rds.hexists(key, hash):
        ...
        tinfo = get_publication_task_info_dict(workspace, publication_type, publication_name)
...
def get_publication_task_info_dict(workspace, publication_type, publication_name):
    rds = settings.LAYMAN_REDIS
...
def get_publication_task_info(workspace, publication_type, publication_name):
    tinfo = get_publication_task_info_dict(workspace, publication_type, publication_name)
...
def set_publication_task_info_dict(workspace, publication_type, publication_name, task_info):
    rds = settings.LAYMAN_REDIS
...
def set_publication_task_info(workspace, publication_type, publication_name, tasks, task_result):
    ...
    set_publication_task_info_dict(workspace, publication_type, publication_name, task_info)
