...
def get_layer_info(uuid, *, extra_keys=None):
    ...
    file_path_info_list = input_file.get_file_path_info(uuid)
    ...
    if len(gdal_paths) > 0:
        ...
        input_file_info = input_file.get_layer_info(uuid)
        ...
        add_file_extra_keys(file_dict, input_file_gdal_path, gdal_paths, extra_keys)
    return result
