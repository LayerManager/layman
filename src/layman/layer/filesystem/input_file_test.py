...
@pytest.mark.parametrize("method_params, exp_filepath_mapping", [
    pytest.param({
        ...
        'publ_uuid': '928618f1-48a7-4c5b-a0e8-8126b796b2d7',
        'output_dir': '/data',
    }, {
        'tmp/countries.cpg': '/data/928618f1-48a7-4c5b-a0e8-8126b796b2d7.cpg',
        'tmp/countries.dbf': '/data/928618f1-48a7-4c5b-a0e8-8126b796b2d7.dbf',
        'tmp/countries.prj': '/data/928618f1-48a7-4c5b-a0e8-8126b796b2d7.prj',
        'tmp/countries.README.html': '/data/928618f1-48a7-4c5b-a0e8-8126b796b2d7.readme.html',
        'tmp/countries.shp': '/data/928618f1-48a7-4c5b-a0e8-8126b796b2d7.shp',
        'tmp/countries.shx': '/data/928618f1-48a7-4c5b-a0e8-8126b796b2d7.shx',
        'tmp/countries.VERSION.txt': '/data/928618f1-48a7-4c5b-a0e8-8126b796b2d7.version.txt',
