...
def get_template_path_and_values(publication: Layer, *, http_method):
    ...
    prop_values = {
        ...
        'identifier': {
            'identifier': url_for('rest_layer.get', uuid=publication.uuid),
            'label': publication.name,
        },
        'abstract': abstract,
        'graphic_url': url_for('rest_layer_thumbnail.get', uuid=publication.uuid),
        'extent': extent,
        ...
        'layer_endpoint': url_for('rest_layer.get', uuid=publication.uuid),
