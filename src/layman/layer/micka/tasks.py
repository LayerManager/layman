...
def refresh_csw(self, username, layername, http_method=consts.REQUEST_METHOD_POST, metadata_properties_to_refresh=None):
...
def refresh_soap(self, username, layername, http_method=consts.REQUEST_METHOD_POST, metadata_properties_to_refresh=None, access_rights=None):
    metadata_properties_to_refresh = metadata_properties_to_refresh or []
    if self.is_aborted():
        raise AbortedException
    if http_method == consts.REQUEST_METHOD_POST:
