...
def validate_and_prepare_append_mode(layer: Layer, input_files, time_regex_from_request, time_regex_format_from_request, *,
    ...
    layer_info_complete = get_complete_layer_info(layer, x_forwarded_items=x_forwarded_items)
    ...
    publ_info = layman_util.get_publication_info(layer, context={'keys': ['wfs_wms_status']})
