...
from layman import util as layman_util, settings, authn, uuid
...
def get():
    ...
    if workspace:
        authorize(workspace, LAYER_TYPE, None, request.method, actor)
...
def post():
    ...
    authorize(workspace, LAYER_TYPE, None, request.method, actor_name)
