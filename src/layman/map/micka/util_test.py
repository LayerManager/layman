...
def test_parse_md_properties():
    ...
    with app.app_context():
        expected = {
            ...
            'identifier': {
                'identifier': url_for('rest_map.get', uuid='f4b2a3d1-2f77-4f7d-9a7e-4a2b0f75e2d3', internal=False),
                'label': 'm-f4b2a3d1-2f77-4f7d-9a7e-4a2b0f75e2d3',
            },
            ...
            'map_endpoint': url_for('rest_map.get', uuid='f4b2a3d1-2f77-4f7d-9a7e-4a2b0f75e2d3',
                                    internal=False),
...
def test_fill_xml_template():
    with app.app_context():
        xml_file_object = common_util.fill_xml_template_as_pretty_file_object('src/layman/map/micka/record-template.xml', {
            ...
            'publication_date': '2007-05-25',
            'identifier': {
                'identifier': url_for('rest_map.get', uuid='91147a27-1ff4-4242-ba6d-faffb92224c6', internal=False),
                'label': 'm-91147a27-1ff4-4242-ba6d-faffb92224c6',
            },
            'abstract': 'World places and boundaries abstract',
            'organisation_name': None,
            'graphic_url': url_for('rest_map_thumbnail.get', uuid='91147a27-1ff4-4242-ba6d-faffb92224c6',
                                   internal=False),
            'extent': [-35, -48.5, 179, 81.5],
            'map_endpoint': url_for('rest_map.get', uuid='91147a27-1ff4-4242-ba6d-faffb92224c6',
                                    internal=False),
