...
from .rest_workspace_map_thumbnail_uuid import bp as rest_uuid_map_thumbnail
...
PUBLICATION_TYPES = {
    f'{MAP_TYPE}': {
        ...
        'multi_info_keys_to_remove': ['geodata_type', 'wfs_wms_status', 'used_in_maps', ],
