...
class TestSelectPublicationsComplex:
    ...
    @pytest.mark.parametrize('query_params, expected_publications', [
        ...
        ({'full_text': 'dva'}, [(workspace1, MAP_TYPE, 'test_select_publications_publication1oe'),
                                ]),
        ({'full_text': 'kun'}, [(workspace1, MAP_TYPE, 'test_select_publications_publication1e'),
                                (workspace1, MAP_TYPE, 'test_select_publications_publication1o'),
                                ]),
        ({'full_text': 'jedna'}, [(workspace1, MAP_TYPE, 'test_select_publications_publication1oe'),
                                  (workspace2, MAP_TYPE, 'test_select_publications_publication2o'),
                                  ]),
        ({'full_text': 'upet'}, []),
        ({'full_text': 'dva | kun'}, [(workspace1, MAP_TYPE, 'test_select_publications_publication1e'),
                                      (workspace1, MAP_TYPE, 'test_select_publications_publication1o'),
                                      (workspace1, MAP_TYPE, 'test_select_publications_publication1oe'),
                                      ]),
        ({'full_text': 'kun & ody'}, [(workspace1, MAP_TYPE, 'test_select_publications_publication1e'),
                                      ]),
    ])
