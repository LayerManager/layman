...
class TestSelectPublicationsComplex:
    ...
    layer_2o_2_2x4_4 = 'test_select_publications_publication2o'
    ...
    @pytest.mark.parametrize('query_params, expected_publications', [
        ...
        ({'full_text_filter': 'dva'}, [(workspace1, MAP_TYPE, layer_1oe_3_7x5_9),
                                       ]),
        ({'full_text_filter': 'games'}, [(workspace2, MAP_TYPE, layer_2e_3_3x5_5),
                                         ]),
        ({'full_text_filter': 'kun'}, [(workspace1, MAP_TYPE, layer_1e_2_4x6_6),
                                       (workspace1, MAP_TYPE, layer_1o_2_2x3_6),
                                       ]),
        ({'full_text_filter': 'jedna'}, [(workspace1, MAP_TYPE, layer_1oe_3_7x5_9),
                                         (workspace2, MAP_TYPE, layer_2o_2_2x4_4),
                                         ]),
        ({'full_text_filter': 'upet'}, []),
        ({'full_text_filter': 'dva | kun'}, [(workspace1, MAP_TYPE, layer_1e_2_4x6_6),
                                             (workspace1, MAP_TYPE, layer_1o_2_2x3_6),
                                             (workspace1, MAP_TYPE, layer_1oe_3_7x5_9),
                                             ]),
        ({'full_text_filter': 'kun & ody'}, [(workspace1, MAP_TYPE, layer_1e_2_4x6_6),
                                             ]),
        ...
        pytest.param({'bbox_filter': (3000, 3000, 5000, 5000),
                      }, [
            (workspace1, MAP_TYPE, layer_1e_2_4x6_6),
            (workspace2, MAP_TYPE, layer_2e_3_3x5_5),
        ], marks=pytest.mark.xfail(reason='Not yet implemented!')),
