...
@pytest.mark.parametrize('endpoint, internal, x_forwarded_items, params, expected_url', [
    ...
    pytest.param('rest_layers.get', False, XForwardedClass(proto='https'), {'workspace': 'workspace_name'},
                 'https://enjoychallenge.tech/rest/layers?workspace=workspace_name',
                 id='get-workspace-layers-x-forwarded-proto'),
    pytest.param('rest_layers.get', False, XForwardedClass(prefix='/proxy'), {'workspace': 'workspace_name'},
                 'http://enjoychallenge.tech/proxy/rest/layers?workspace=workspace_name',
                 id='get-workspace-layers-x-forwarded-prefix'),
    pytest.param('rest_layers.get', False, XForwardedClass(prefix=''), {'workspace': 'workspace_name'},
                 'http://enjoychallenge.tech/rest/layers?workspace=workspace_name',
                 id='get-workspace-layers-x-forwarded-prefix-empty-string'),
    pytest.param('rest_layers.get', False, XForwardedClass(proto='https', host='foo.com', prefix='/proxy'),
                 {'workspace': 'workspace_name'},
                 'https://foo.com/proxy/rest/layers?workspace=workspace_name',
                 id='get-workspace-layers-x-forwarded-proto-host-prefix'),
    pytest.param('rest_layers.get', False, XForwardedClass(host='localhost:3001'),
                 {'workspace': 'workspace_name'},
                 'http://localhost:3001/rest/layers?workspace=workspace_name',
