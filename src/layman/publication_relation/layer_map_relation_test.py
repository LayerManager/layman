...
def assert_map_thumbnail(publ_uuid, expected_thumbnail_path):
    process_client.wait_for_publication_status(publ_uuid, process_client.MAP_TYPE)
...
def test_map_refresh_after_layer_change():
    ...
    assert_map_thumbnail(publ_uuid, f'/code/test_tools/data/thumbnail/map_with_internal_layer_basic.png')
    ...
    assert_map_thumbnail(publ_uuid, f'/code/test_tools/data/thumbnail/map_with_internal_layer_basic_after_wfst.png')
