...
def get():
    ...
    x_forwarded_items = util.get_x_forwarded_items(request.headers)
    return rest_common.get_publications(publication_type=None, actor=actor, request_args=request.args, x_forwarded_items=x_forwarded_items)
