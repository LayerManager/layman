...
def ensure_layer():
    def ensure_layer_internal(workspace, layer):
        ...
        with app.app_context():
            ...
            gs_layer.publish_layer_from_db(workspace, layer, layer, layer, crs='EPSG:3857', geoserver_workspace=workspace)
            ...
            gs_layer.publish_layer_from_db(workspace, layer, layer, layer, crs='EPSG:3857', geoserver_workspace=geoserver_workspace)
            gs_layer.set_security_rules(workspace, layer, None, settings.LAYMAN_GS_AUTH, geoserver_workspace)
