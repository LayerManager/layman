...
LAYMAN_GS_PROXY_PORT = os.environ['LAYMAN_GS_PROXY_PORT']
...
LAYMAN_GS_PROXY_BASE_URL = urljoin(f'http://{LAYMAN_PROXY_SERVER_NAME}:{LAYMAN_GS_PROXY_PORT}', LAYMAN_GS_PATH)
