...
class TestLayerAppend(base_test.TestSingleRestPublication):
    ...
    def _assert_timeseries_layer_state(self, uuid, expected_file_basenames, expected_time_values):
        with app.app_context():
            info = process_client.get_layer(uuid)
    ...
    def test_timeseries_append_flow(self, layer: Publication4Test, rest_method, rest_args):
        ...
        self._assert_timeseries_layer_state(uuid, initial_file_basenames, expected_times_before)
        ...
        process_client.patch_layer(uuid, **patch_args)
        ...
        self._assert_timeseries_layer_state(uuid, all_file_basenames, expected_times_after)
