...
SOURCE_CRS = {
    ...
    crs_def.EPSG_3034: {
        KEY_INFO_VALUES: {
            'exp_publication_detail': {
                'native_bounding_box': [4464503.1786742, 2519864.5577388, 4464521.7093864, 2519881.639366],
                'bounding_box': [1848635.5785640941, 6308679.192778346, 1848667.1735165308, 6308708.795145725],
            }
        },
    },
    crs_def.EPSG_3035: {
    ...
    for crs, tc_params in SOURCE_CRS.items():
        ...
        for rest_param_dict in rest_param_dicts:
            ...
            for action_code, action_method, action_predecessor in [
                ...
                publ_name = "_".join([part for part in ['raster', f'{crs_code}', action_code, test_case_postfix] if part])
