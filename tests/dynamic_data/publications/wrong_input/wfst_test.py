...
from layman import LaymanError, app, util as layman_util, names
...
class TestWfst(base_test.TestSingleRestPublication):
    ...
    def test_proxy_raises(self, layer: Publication, params):
        with app.app_context():
            layer_uuid = layman_util.get_publication_uuid(layer.workspace, process_client.LAYER_TYPE, layer.name)
