...
LAYERS = {
    ...
    'access_rights': {
        Key.PATCH_REST_ARGS: {'access_rights': {'read': ['EVERYONE', WORKSPACE], 'write': [WORKSPACE]}, },
    }
}
...
def generate_test_cases():
    ...
    for name, test_case_params in LAYERS.items():
        for layer_by_server in base_test.LayerByUsedServers:
            ...
            rest_args = {**layer_by_server.publication_definition.definition, **{'headers': AUTHN_HEADERS, }}
...
class TestLayer(base_test.TestSingleRestPublication):
    ...
    def test_layer(self, layer, rest_args, params):
        ...
        self.patch_publication(publication=layer,
                               args={**params[Key.PATCH_REST_ARGS], **{'headers': AUTHN_HEADERS, }})
