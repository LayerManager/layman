...
### Changes
- [#1048](https://github.com/LayerManager/layman/issues/1048) New key `wfs`.`name` was added to [GET Workspace Layer](doc/rest.md#get-workspace-layer) response.
- [#1048](https://github.com/LayerManager/layman/issues/1048) Names of [Feature types and Layers in GeoServer WFS workspace](doc/data-storage.md#geoserver) are `l_<uuid>`.
