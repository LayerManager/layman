...
- [#1126](https://github.com/LayerManager/layman/issues/1126) Migrate map file endpoint URLs in map metadata from workspace&name-based format to UUID-based format.
