...
### Changes
- [#1064](https://github.com/LayerManager/layman/issues/1064) [DELETE User](doc/rest.md#delete-user) now grants deletion rights to users or roles defined in the [GRANT_DELETE_OTHER_USER] environment variable.
