...
#### Schema migrations
- [#703](https://github.com/LayerManager/layman/issues/703) Create new json column `table_uri` in `publications` table in prime DB schema.
#### Data migrations
- [#703](https://github.com/LayerManager/layman/issues/703) Fill column `table_uri` in `publications` table in prime DB schema for all publications. Value is set to `null` for all existing publications.
### Changes
