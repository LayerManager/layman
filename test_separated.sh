...
python3 src/assert_db.py && python3 src/wait_for_deps.py && python3 src/clear_layman_data.py && TEST_TYPE=mandatory python3 -m pytest -W ignore::DeprecationWarning -xvv --ignore=tests/static_data/ tests
