...
<qgis maxScale="0" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" simplifyDrawingTol="1" simplifyAlgorithm="0" version="3.16.2-Hannover" readOnly="0" styleCategories="AllStyleCategories" minScale="100000000" labelsEnabled="0" simplifyLocal="1">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <temporal durationField="" fixedDuration="0" durationUnit="min" endField="" startField="" startExpression="" enabled="0" mode="0" endExpression="" accumulate="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <renderer-v2 attr="class" type="categorizedSymbol" forceraster="0" enableorderby="0" symbollevels="0">
    <categories>
      <category value="1" symbol="0" render="true" label="1"/>
      <category value="2" symbol="1" render="true" label="2"/>
      <category value="3" symbol="2" render="true" label="3"/>
    </categories>
    <symbols>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory backgroundAlpha="255" maxScaleDenominator="1e+8" spacingUnitScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" sizeType="MM" opacity="1" scaleBasedVisibility="0" barWidth="5" width="15" penColor="#000000" spacingUnit="MM" backgroundColor="#ffffff" height="15" minScaleDenominator="0" penWidth="0" diagramOrientation="Up" scaleDependency="Area" spacing="5" direction="0" enabled="0" lineSizeType="MM" rotationOffset="270" showAxis="1" lineSizeScale="3x:0,0,0,0,0,0" minimumSize="0" penAlpha="255">
  ...
  <DiagramLayerSettings placement="1" linePlacementFlags="18" priority="0" zIndex="0" showAll="1" obstacle="0" dist="0">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <referencedLayers/>
  <fieldConfiguration>
    <field configurationFlags="None" name="geometry_type_name">
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" field="class" constraints="0" exp_strength="0" unique_strength="0"/>
  </constraints>
...
def my_form_open(dialog, layer, feature):
  ...
  <widgets/>
  <previewExpression>"geometry_type_name"</previewExpression>
  <mapTip></mapTip>
